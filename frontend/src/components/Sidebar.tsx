...
import { Moon, Sun, Menu, X, Settings, FileText, Globe, MessageSquare } from 'lucide-react';
...
export const Sidebar: React.FC = () => {
  ...
  const handleClearDocuments = () => {
    if (window.confirm('Êtes-vous sûr de vouloir effacer tous les documents ?')) {
      clearDocuments();
    }
  };
